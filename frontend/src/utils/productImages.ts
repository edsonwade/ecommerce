const CATEGORY_IMAGES: Record<string, string> = {
  ...
  // Granular hardware categories (V10)
  motherboards: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&auto=format&fit=crop',
  processors: 'https://images.unsplash.com/photo-1555617981-dac3880eac6e?w=400&auto=format&fit=crop',
  graphicscards: 'https://images.unsplash.com/photo-1591488320449-011701bb6704?w=400&auto=format&fit=crop',
  memory: 'https://images.unsplash.com/photo-1562976540-1502c2145186?w=400&auto=format&fit=crop',
  powersupplies: 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=400&auto=format&fit=crop',
  cpucoolers: 'https://images.unsplash.com/photo-1587202372616-b43abea06c2a?w=400&auto=format&fit=crop',
  headphones: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&auto=format&fit=crop',
  headsets: 'https://images.unsplash.com/photo-1599669454699-248893623440?w=400&auto=format&fit=crop',
  speakers: 'https://images.unsplash.com/photo-1545454675-3531b543be5d?w=400&auto=format&fit=crop',
  microphones: 'https://images.unsplash.com/photo-1590602847861-f357a9332bbc?w=400&auto=format&fit=crop',
