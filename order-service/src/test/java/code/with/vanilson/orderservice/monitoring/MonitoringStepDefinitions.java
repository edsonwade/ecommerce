...
public class MonitoringStepDefinitions {
    ...
    @When("an anonymous client requests a protected order endpoint")
    public void anAnonymousClientRequestsAProtectedOrderEndpoint() {
        protectedResponse = restTemplate.getForEntity("/api/v1/orders/1", String.class);
    }
