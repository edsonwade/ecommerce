...
public class MonitoringStepDefinitions {
    ...
    @When("an anonymous client requests a protected payment endpoint")
    public void anAnonymousClientRequestsAProtectedPaymentEndpoint() {
        protectedResponse = restTemplate.getForEntity("/api/v1/payments/1", String.class);
    }
