...
class PageImplRedisSerializerTest {
    ...
    void pageImpl_roundTrip_preservesContentAndPagination() throws Exception {
        List<ProductResponse> products = List.of(
                new ProductResponse(1, "Laptop", "A laptop", 10.0, new BigDecimal("999.99"), 1, "Electronics", "Devices", "admin", null, ProductStatus.ACTIVE, BigDecimal.ZERO, 0),
                new ProductResponse(2, "Phone", "A phone", 5.0, new BigDecimal("499.99"), 1, "Electronics", "Devices", "admin", null, ProductStatus.ACTIVE, BigDecimal.ZERO, 0)
        );
    ...
    void pageImpl_secondPage_preservesPaginationMetadata() throws Exception {
        List<ProductResponse> products = List.of(
                new ProductResponse(21, "Tablet", "A tablet", 3.0, new BigDecimal("299.99"), 2, "Tech", "Gadgets", "seller", null, ProductStatus.ACTIVE, BigDecimal.ZERO, 0)
        );
